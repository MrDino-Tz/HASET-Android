...
public class PastAppointmentsFragment extends Fragment implements AppointmentAdapter.OnAppointmentActionListener {
        ...
        viewModel.getPastAppointments().observe(getViewLifecycleOwner(), appointments -> {
            if (isAdded() && rootView != null) {
                ...
                if (appointments == null || appointments.isEmpty()) {
                    showEmptyState(getString(R.string.no_completed_appointments_title),
                            getString(R.string.no_completed_appointments_desc),
    ...
    public void onAppointmentClick(Appointment appointment) {
        // Handle appointment click - do nothing for past appointments
    }
    ...
    public void onRateDoctor(Appointment appointment) {
        if (appointment != null && Constants.ROLE_PATIENT.equals(preferenceManager.getUserRole())) {
            RateDoctorBottomSheet bottomSheet = RateDoctorBottomSheet.newInstance(appointment);
            bottomSheet.show(getParentFragmentManager(), "RateDoctorBottomSheet");
        }
    }

    @Override
    public void onStartSession(Appointment appointment) {
        // Not applicable for past appointments
    }
    @Override
