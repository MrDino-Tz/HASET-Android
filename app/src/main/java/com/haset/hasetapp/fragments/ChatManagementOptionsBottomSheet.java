...
public class ChatManagementOptionsBottomSheet extends BottomSheetDialogFragment {
    ...
    public static final String TAG = "ChatManagementOptionsBottomSheet";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_chat_management_options, container, false);
        ...
        llDeleteMessages.setOnClickListener(v -> {
            Toast.makeText(getContext(), R.string.delete_messages_soon, Toast.LENGTH_SHORT).show();
            dismiss();
        });

        llSearchMessages.setOnClickListener(v -> {
            Toast.makeText(getContext(), R.string.search_messages_soon, Toast.LENGTH_SHORT).show();
            dismiss();
        });
